defmodule PiAi.Provider.OpenAICompat do
  @moduledoc "Shared streaming implementation for OpenAI-compatible providers."
  ...
  def stream_chat(api_url, model, messages, opts, provider_key) do
    ...
    body = if temp = Keyword.get(opts, :temperature), do: Map.put(body, :temperature, temp), else: body
    ...
    try do
      ...
      e -> {:error, "HTTP request failed: #{inspect(e)}"}
    end
  end
